...
export default function SuratMasuk() {
    ...
    async function getSuratMasuk() {
        const res = await axios.get(
            `${process.env.HOST}/pimpinan/surat/masuk`
        );
                                    ...
                                    return (
                                        <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4">{
                                                item.status_surat === 'proggress'
                                                    ...
                                                    : item.status_surat === 'unread'
                                                        ? <span className="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-400 border border-yellow-400">Menunggu Disposisi</span>
                                            ...
                                            <td className="px-6 py-4 text-center inline-flex">
                                                <a href={`/pimpinan/surat/masuk/disposisi/${item.id}`} data-tooltip-target="tooltip-edit" className="inline-flex items-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
