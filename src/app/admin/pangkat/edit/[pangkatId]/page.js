...
export default function EditPangkat() {
    const params = useParams();
    const pangkatId = params.pangkatId;
    ...
    async function getPangkatById() {
        ...
        setNamaPangkat(response.nama_pangkat);
    };
                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Edit Pangkat</a>
                        </div>
                    </li>
                </ol>
            </nav>
