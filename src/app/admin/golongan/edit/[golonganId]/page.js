...
export default function EditGolongan() {
    const params = useParams();
    const golonganId = params.golonganId;
    const [nama_golongan, setNamaGolongan] = useState("");
    ...
    async function getGolonganById() {
        ...
        setNamaGolongan(response.nama_golongan);
    };
        ...
        <LayoutAdmin>
            ...
            <nav className="flex mb-5" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    <li className="inline-flex items-center">
                        <a href="/admin/golongan" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                    ...
                    <li>
                        <div className="flex items-center">
                            ...
                            <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Edit Golongan</a>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <form onSubmit={saveGolongan}>
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="mb-6">
                        <label htmlFor="base-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Golongan</label>
                        <input type="text" id="base-input" className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={nama_golongan} onChange={(e) => setNamaGolongan(e.target.value)} />
                    </div>
                    <div className="mb-6"></div>
                </div>
                <hr className='mb-3' />
                <div className="flex mb-6">
                    ...
                    <Link href='/admin/golongan' className="flex py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
