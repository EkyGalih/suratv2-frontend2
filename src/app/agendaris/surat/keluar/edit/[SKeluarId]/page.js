...
export default function EditSuratKeluar() {
  ...
  const [disposisi, setDisposisi] = useState("--Belum Disposisi--");
  ...
  const saveSurat = async (e) => {
    ...
    try {
      await axios.patch(
        `${process.env.HOST}/agendaris/surat/${suratId}`, formData, {
        "Content-type": "multipart/form-data"
      });
      router.push('/agendaris/surat/keluar');
    } catch (error) {
      if (error.response) {
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              <a href="#" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Edit Surat Keluar</a>
            </div>
          </li>
        </ol>
      </nav>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          <div className="col-span-1">
            <div className="mb-3 text-gray-500 dark:text-gray-400">
              <label htmlFor="perihal" className="block mb-2 mr-5 text-sm font-medium text-gray-900 dark:text-white">Bidang</label>
              <input type="text" disabled placeholder="" id="no-surat" className="bg-gray-100 border cursor-not-allowed border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={bidang} onChange={(e) => setBidang(e.target.value)} />
            </div>
            <div className="mb-3 text-gray-500 dark:text-gray-400">
            ...
            <div className="mb-3 text-gray-500 dark:text-gray-400">
              <label htmlFor="perihal" className="block mb-2 mr-5 text-sm font-medium text-gray-900 dark:text-white">Jenis Surat</label>
              <input type="text" disabled placeholder="" id="no-surat" className="bg-gray-100 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={kategori} onChange={(e) => setKategori(e.target.value)} />
            </div>
            <div className="mb-3 text-gray-500 dark:text-gray-400">
              <label htmlFor="perihal" className="block mb-2 mr-5 text-sm font-medium text-gray-900 dark:text-white">Perihal</label>
              <textarea id="perihal" disabled rows="4" className="cursor-not-allowed block p-2.5 w-full text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={perihal} onChange={(e) => setPerihal(e.target.value)}></textarea>
            </div>
            <div className="mb-3 text-gray-500 dark:text-gray-400">
              <label htmlFor="perihal" className="block mb-2 mr-5 text-sm font-medium text-gray-900 dark:text-white">Disposisi</label>
              <textarea id="perihal" disabled rows="4" className="cursor-not-allowed block p-2.5 w-full text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={disposisi} onChange={(e) => setDisposisi(e.target.value)}></textarea>
            </div>
            <div className="mb-3 text-gray-500 dark:text-gray-400">
              <label htmlFor="perihal" className="block mb-2 mr-5 text-sm font-medium text-gray-900 dark:text-white">Tanggal Surat</label>
              <input type="date" placeholder="" disabled id="tanggal-lahir" className="bg-gray-100 cursor-not-allowed border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value={tgl_surat} onChange={(e) => setTglSurat(e.target.value)} />
            </div>
            <div className="inline-flex mb-3 text-gray-500 dark:text-gray-400">
              ...
              <a href='/agendaris/surat/keluar' className="flex py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
