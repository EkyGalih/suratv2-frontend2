                                    ...
                                    return (
                                        <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4 text-center inline-flex">
                                                <a href={`/agendaris/surat/keluar/edit/${item.id}`} data-tooltip-target="tooltip-edit" class="inline-flex items-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900">
                                                ...
                                                <a href={`/agendaris/surat/keluar/detail/${item.id}`} data-tooltip-target="tooltip-view" className="inline-flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
