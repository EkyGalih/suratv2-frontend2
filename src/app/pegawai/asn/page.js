...
export default function PegawaiAsn() {
        ...
        <Layout>
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg ml-10 mr-10 mt-5">
                <h1 className="inline-flex text-2xl px-5 pt-5 font-extrabold text-black">
                    <svg className="w-6 h-6 mr-2 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
