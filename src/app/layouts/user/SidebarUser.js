                ...
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pegawai" className="hidden py-2 space-y-2">
                            <li>
                                <a href="/user/distribusi/surat/masuk" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            ...
                            <li>
                                <a href="/user/distribusi/surat/keluar" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                    <svg className="w-2.5 h-2.5 mr-1 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 10 16">
                                        <path d="M3.414 1A2 2 0 0 0 0 2.414v11.172A2 2 0 0 0 3.414 15L9 9.414a2 2 0 0 0 0-2.828L3.414 1Z" />
                                    </svg>
